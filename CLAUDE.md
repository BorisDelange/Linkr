...
- **Ongoing work-in-progress plans** (full-stack backend, auth, IDE) → `docs/planning/` — read the latest "État de session" for what's done vs. still TODO before starting related work.
