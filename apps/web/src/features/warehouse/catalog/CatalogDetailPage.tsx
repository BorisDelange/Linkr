      ...
      <div className="px-6 py-6">
        ...
        <Tabs defaultValue="config" className="mt-6">
          <TabsList>
            ...
            <TabsTrigger value="anonymization" disabled>{t('data_catalog.tab_anonymization')}</TabsTrigger>
            <TabsTrigger value="dcat" disabled>{t('data_catalog.tab_dcat')}</TabsTrigger>
