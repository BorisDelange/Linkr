...
export function DdlERDGroupPanel({ groups, allTables, onChange, onClose }: DdlERDGroupPanelProps) {
  ...
  return (
    <div className="w-[300px] shrink-0 border-l bg-card flex flex-col">
      <div className="flex items-center justify-between px-3 py-2 border-b">
        <span className="text-xs font-semibold text-foreground">{t('schemas.erd_groups')}</span>
                ...
                {isExpanded && (
                  <div className="px-3 pb-3 space-y-2 border-t">
                    ...
                    <div className="pt-1">
                      ...
                      <div className="mt-1 max-h-[200px] overflow-auto space-y-px">
