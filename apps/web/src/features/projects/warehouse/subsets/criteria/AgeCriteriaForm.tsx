  ...
  return (
    <div className="grid grid-cols-2 gap-3">
      <div className="space-y-1">
        <Label className="text-xs">{t('subsets.age_min')}</Label>
        <div className="flex items-center gap-1.5">
          ...
          />
          <span className="text-xs text-muted-foreground shrink-0">{t('subsets.age_years')}</span>
        </div>
      </div>
      <div className="space-y-1">
        <Label className="text-xs">{t('subsets.age_max')}</Label>
        <div className="flex items-center gap-1.5">
          <Input
            type="number"
            value={c.max ?? ''}
