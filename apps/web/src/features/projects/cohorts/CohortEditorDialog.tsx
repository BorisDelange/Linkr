  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-lg max-h-[85vh] flex flex-col">
        <DialogHeader>
          <DialogTitle>
            {isEditing ? t('cohorts.editor_title_edit') : t('cohorts.editor_title')}
          </DialogTitle>
          <DialogDescription>{t('cohorts.editor_description')}</DialogDescription>
        </DialogHeader>
        ...
        <div className="flex-1 overflow-auto space-y-5 py-2">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-muted-foreground">{t('cohorts.field_level_description')}</p>
          ...
          <div className="space-y-3">
            <Label>{t('cohorts.criteria_title')}</Label>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="age">{t('cohorts.criteria_age')}</SelectItem>
                      <SelectItem value="sex">{t('cohorts.criteria_sex')}</SelectItem>
                      <SelectItem value="period">{t('cohorts.criteria_period')}</SelectItem>
                      <SelectItem value="duration">{t('cohorts.criteria_duration')}</SelectItem>
          ...
          {dataSourceId && criteria.length > 0 && (
            <div className="flex items-center gap-2 rounded-lg border bg-muted/30 px-3 py-2">
              ...
              >
                ...
                {previewLoading
                  ? t('cohorts.preview_computing')
                  : previewError
                    ? t('cohorts.preview_error')
                    : previewCount != null
                      ? t('cohorts.preview_count', { count: previewCount })
                      : t('cohorts.execute')}
              </Button>
            </div>
          )}
