/**
 * OMOP CDM v5.4 DDL for DuckDB.
 * Source: https://github.com/OHDSI/CommonDataModel/tree/main/inst/ddl/5.4/duckdb
 *
 * - Schema placeholder (@cdmDatabaseSchema) removed — tables created in caller-specified schema
 * - HINT comments removed (distribution hints for MPP engines, ignored by DuckDB)
 * - Primary key constraints included inline
 */
