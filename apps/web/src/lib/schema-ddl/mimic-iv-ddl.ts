/**
 * MIMIC-IV v2.2 DDL for DuckDB.
 * Source: https://github.com/MIT-LCP/mimic-code/blob/main/mimic-iv/buildmimic/postgres/create.sql
 *
 * - Schema prefixes (mimiciv_hosp, mimiciv_icu) removed — tables created in caller-specified schema
 * - DROP TABLE statements removed
 * - TIMESTAMP(n) precision simplified to TIMESTAMP
 * - CHAR(n) changed to VARCHAR
 * - FLOAT kept as-is (DuckDB supports FLOAT = REAL = FLOAT4)
 */
