...
async def list_readme(
    ...
    await _require_project(db, project_uid, user, "viewer")
...
async def create_readme(
    ...
    await _require_project(db, project_uid, user, "editor")
    data = await request.body()
    return await attachment_service.create_readme(
        db, id=id, project_uid=project_uid, file_name=file_name,
...
async def get_readme_blob(
    ...
    await _require_project(db, att.project_uid, user, "viewer")
