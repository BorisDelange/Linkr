...
| Effort | Doc | Status |
|---|---|---|
| **Versioning** (pull for other scopes, front-only pull, stripping, server import, foreign files, LFS test) | [versioning-plan.md](versioning-plan.md) | Infra + pilots DONE; leftovers listed, incl. several TODO and one TO TEST |
